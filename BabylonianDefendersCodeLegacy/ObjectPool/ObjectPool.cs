...
public class ObjectPool : GenericSingleton<ObjectPool, IGenericPooler>, IGenericPooler
{
    ...
    private void InitPools()
    {
        ...
        UnityEngine.Object[] allPoolableObjects = Resources.LoadAll("PoolableObjects", typeof(ScriptablePoolObject));
        foreach (ScriptablePoolObject prototype in allPoolableObjects)
        {
